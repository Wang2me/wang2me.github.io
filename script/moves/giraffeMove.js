...
markers.giraffe2 = createMarker({ lat:22.5652,lng:88.3522}, 'giraffe','印度加爾各答',{ A:['giraffe'], B:['明'],C:['朝貢'],D:['海上絲綢之路'],E:['南亞'] },
   {title_cn: '描述',title_en: 'Description'  
	,description_cn:'榜葛剌位於如今的孟加拉國以及印度東部地區。榜葛剌曾經兩次向明朝進貢長頸鹿。在台北故宮博物院收藏有一幅名為《明人畫麒麟沈度頌》的繪畫，其內容是永樂十二年（公元1414年）榜葛剌使者進貢的長頸鹿。研究人員認為，這幅畫應該是由明朝宮廷畫師繪製並賞賜給大臣的，有政治宣傳的意義。'  
...
markers.giraffe5 = createMarker({ lat:21.4042,lng:39.7987 }, 'giraffe','沙特阿拉伯麥加',{ A:['giraffe'], B:['明'],C:['朝貢'],D:['海上絲綢之路'],E:['西亞'] },
   {title_cn: '描述',title_en: 'Description'  
